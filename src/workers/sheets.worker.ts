...
import { centsToReais } from '../shared/currency.js';
...
export function buildRow(job: WebhookJob): (string | number | null)[] {
  ...
  return [
    ...
    /* 30 Preço Original        */ centsToReais(o.product_base_price),
